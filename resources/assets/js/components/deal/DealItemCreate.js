...
export default class DealItemCreate extends Component {
    constructor(props) {
        super(props);
        this.state = {
        }
        this.handleCreateDeal = this.handleCreateDeal.bind(this);
    }
    handleCreateDeal() {
        let deal = {
    ...
    render() {
        ...
        let transaction_id = this.props.transaction_id;
        return (
            <div className="row comment">
                ...
                <div className="col-md-11">
                    ...
                    <textarea ref="comment" className="form-control margin-bottom-5" name="message" placeholder="Write deal"></textarea> 
                    <button type="submit" className="btn btn-sm btn-color btn-md btn-message" onClick={this.handleCreateDeal}>Send</button>
                </div>
