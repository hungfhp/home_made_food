...
export default class Food extends Component {
    render() {
        return (
            <div className="modal property-modal fade" id="propertyModal" tabIndex="-1" role="dialog" aria-labelledby="propertyModalLabel"
                aria-hidden="true">
                                ...
                                <div className="col-lg-6 modal-left">
                                    <div className="modal-left-content">
                                        <div id="modalCarousel" className="carousel slide" data-ride="carousel">
                                            <div className="carousel-inner" role="listbox">
                                                <div className="carousel-item active">
                                                    <iframe className="modalIframe" src="https://www.youtube.com/embed/5e0LxrLSzok" allowFullScreen />
                                                </div>
                                                <div className="carousel-item">
                                                    <img src="/img/property-1.jpg" alt="Test ALT" />
                                                </div>
                                                <div className="carousel-item">
                                                    <img src="/img/property-1.jpg" alt="Test ALT" />
                                                </div>
                                        ...
                                        <div className="description">
                                            <h3>Description</h3>
                                            <p>
                                                Curabitur odio nibh, luctus non pulvinar a, ultricies ac diam. Donec neque massa, viverra interdum eros ut, imperdiet pellentesque
                                                mauris. Proin sit amet scelerisque risus. Donec semper semper erat ut mollis. Curabitur
                                                suscipit, justo eu dignissim lacinia, ante sapien pharetra duin consectetur eros augue
                                                sed ex. Donec a odio rutrum,
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="modal-right-content bg-white">
                                        ...
                                        <section>
                                            ...
                                            <ul className="bullets">
                                                ...
                                                <li>
                                                    <i className="flaticon-green-park-city-space" />{" "} Private space
                                                </li>
                                            </ul>
                                        </section>
                                        <section>
                                        ...
                                        <section>
                                            ...
                                            <p>
                                                Curabitur odio nibh, luctus non pulvinar a, ultricies ac diam. Donec neque massa, viverra interdum
                                            </p>
                                        </section>
                                        <a href="properties-details.html" className="btn btn-black">
                                            Show Detail
                                        </a>
                                    </div>
                                </div>
